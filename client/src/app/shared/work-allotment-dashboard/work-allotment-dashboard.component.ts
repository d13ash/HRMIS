...
// DataService
@Component({
  selector: 'app-work-allotment-dashboard',
  templateUrl: './work-allotment-dashboard.component.html',
  styleUrl: './work-allotment-dashboard.component.scss'
})
export class WorkAllotmentDashboardComponent implements OnInit {
